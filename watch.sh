...
# execution only.
#
# Usage example: Trigger gsync for synchronizing file changes.
# ./watch.sh gsync -Cra --out-format='[%t]--%n' --delete SOURCE TARGET
#
# ./watch.sh gsync -Cra --out-format='[%t]--%n' --include core \
